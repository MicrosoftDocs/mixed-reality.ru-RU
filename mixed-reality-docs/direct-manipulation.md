...
Двухмерный экран — это голографический контейнер с содержимым двухмерных приложений, такой как веб-браузер. Концепция для взаимодействия с двумерным экраном с помощью непосредственного манипулирования заключается в применении мысленной модели взаимодействия с физическим сенсорным экраном.
...
:::row:::
    ...
    :::column-end:::
    :::column:::
       ![Масштаб](images/manipulate-2d-slate-scale.jpg)<br>
        **Масштаб**<br>
...
:::row:::
    ...
    :::column-end:::
    :::column:::
       ![Масштаб](images/3d-object-manipulation-scale.jpg)<br>
       **Масштаб**<br>
...
:::row:::
    ...
    :::column-end:::
    :::column:::
       ![Масштаб](images/instinctual-gestures-largeobject.jpg)<br>
       **Крупный объект**<br>
    :::column-end:::
:::row-end:::
