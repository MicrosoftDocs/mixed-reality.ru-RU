...
6.  Щелкните **выбрать папку** , чтобы начать сборку в этом расположении.
    ...
    ![выберите папку сборок](images/AzureLabs-Lab3-45.png)
...
![проверить фразы продолжительностью](images/AzureLabs-Lab3-49.png)
![удалить метку Image](images/AzureLabs-Lab3-50.png)
