---
title: Пример использования. запись и создание содержимого для Холотаур
description: Холотаур для Microsoft HoloLens предоставляет впечатляющие трехмерные обзоры значков по всему миру.
author: DannyAskew
ms.author: daaske
ms.date: 03/21/2018
ms.topic: article
...
ms.locfileid: "63518301"
---
# <a name="case-study---capturing-and-creating-content-for-holotour"></a>Пример использования. запись и создание содержимого для Холотаур
...
Использование возможностей [пространственного звука](spatial-sound.md) в HoloLens очень важно для создания убедительного практического впечатления. Мы использовали массив с четырьмя микрофонами, расположенный под камерами на трипод, который бы мог записать звук из расположения камеры в четырех направлениях, предоставив нам достаточно информации для создания пространственных звуков в нашем монтажном кадре.
