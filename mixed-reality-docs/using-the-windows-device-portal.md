...
* **События**: список событий трассировки событий Windows выбранных поставщиков в формате таблицы. Эта таблица обновляется в режиме реального времени. Под таблицей нажмите кнопку Clear ( **очистить** ), чтобы удалить все события ETW из таблицы. Это не приводит к отключению каких-либо поставщиков. Вы можете щелкнуть **Сохранить в файл**, чтобы экспортировать собранные события трассировки событий Windows локально в CSV-файл.
