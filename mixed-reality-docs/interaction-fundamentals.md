...
<table>
    ...
    <tr>
        ...
        <td>Отлично подходят для новых пользователей<br>Короткое время обучения<br>На основе точных легко читаемости visual<br>Согласованное UX в наличии отслеживания и контроллеров DoF 6<br>Отлично, в сочетании с voice, отслеживания, head или помощи</td>
        <td>HoloLens 2<br>Windows Иммерсивных с 6DOF контроллеров</td>
    </tr>
    <tr>
        <td><a href="hands-free.md">Без участия пользователя</a></td>
    ...
    <tr>
        <td><a href="gaze-and-commit.md">HEAD взглядом и фиксации</a></td>
