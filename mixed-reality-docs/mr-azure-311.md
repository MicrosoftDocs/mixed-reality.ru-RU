...
5.  Оставаясь в **файл > Параметры сборки**, убедитесь, что:
...
1.  Щелкните правой кнопкой мыши **активы** папку в *панель проекта*, а затем выберите **создать* > *папки**. Назовите папку **сценариев**.

    ![](images/AzureLabs-Lab311-26.png)
    ![](images/AzureLabs-Lab311-27.png)

2.  Откройте **сценарии** папки затем, внутри этой папки, щелкните правой кнопкой мыши, **создать* > *C\# Script**. Назовите сценарий **MeetingsUI.**
