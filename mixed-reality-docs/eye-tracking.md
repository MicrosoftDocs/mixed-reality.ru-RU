...
HoloLens 2 предоставляет разработчикам возможность использовать информацию о том, что видят пользователи, с новым уровнем контекста и человеческим пониманием в Holographic. Эта страница указывает разработчикам, как они могут воспользоваться преимуществами отслеживания взгляда для различных вариантов использования, а также то, что следует искать при проектировании взаимодействия пользователя на основе взгляда. 
...
Сведения о том, где или как видят пользователи, могут быть чрезвычайно мощным средством — он помогает оценить удобство использования дизайнов и выявлять проблемы в рабочих процессах, чтобы сделать их более эффективными.
...
Корпорация Майкрософт предназначена для облегчения инноваций, а также для обеспечения информирования пользователей о том, как используются сведения об отслеживании взгляда.  Мы будем работать с нашими разработчиками и группами UX, чтобы предоставить рекомендации третьим сторонам, которые гарантируют, что пользователи будут центрированы вокруг пользователя.  


Другие приложения из этой сферы поддерживают следующие функции: 
-   **Удаленный взгляд — визуализация взгляда:** Удаленное отображение взгляда: Визуализация удаленных участников совместной работы для обеспечения немедленной обратной связи и упрощения более точной обработки информации.
...
-   **Оценка проектирования, маркетинговые и потребительские исследования:** Отслеживание взгляда позволяет коммерческим компаниям проводить маркетинговые и потребительские исследования в реальных средах или анализировать перехват внимания пользователя для улучшения дизайна продукта или пространства. 
