...
### <a name="common-step-4-choose-the-correct-adapter"></a>Общий шаг 4. Выбор подходящего адаптера
...
### <a name="unity-step-1-review-the-common-porting-steps-listed-above"></a>Unity шаг 1. Ознакомьтесь с общими действиями по переносу, перечисленными выше.
...
### <a name="unity-step-4-target-your-application-to-run-on-win32"></a>Unity шаг 4. Настройка приложения для запуска в Win32
...
### <a name="unity-step-5-setup-your-windows-mixed-reality-hardware"></a>Unity шаг 5. Настройка оборудования Windows Mixed Reality
...
### <a name="unity-step-6-target-your-application-to-run-on-windows-mixed-reality"></a>Unity шаг 6. Настройка приложения для запуска в Windows Mixed Reality
...
### <a name="unity-step-7-use-the-stage-to-place-content-on-the-floor"></a>Unity шаг 7. использование этапа для размещения содержимого в этаже
...
### <a name="unity-step-8-work-through-your-input-model"></a>Unity шаг 8. Работа с входной моделью
...
### <a name="unity-step-9-performance-testing-and-tuning"></a>Unity, шаг 9. Тестирование и настройка производительности
