...
Если вы используете платформу Win32, можно пропустить этот шаг и перейти к шагу 5.
...
* Вы можете пропустить пункт "Unity Step 5", так как вы намерены ориентироваться на платформу UWP вместо Win32.
...
### <a name="unity-step-5-target-your-application-to-run-on-win32"></a>Unity шаг 5. Настройка приложения для запуска в Win32
