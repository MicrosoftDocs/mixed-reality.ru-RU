...
### <a name="ux-elements-for-the-mixed-realityapp-patterns-landingpagemd"></a>[Элементы пользовательского интерфейса для смешанной реальности](app-patterns-landingpage.md)
