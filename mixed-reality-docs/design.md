...
### <a name="ux-elements-for-the-mixed-reality"></a>[Элементы пользовательского интерфейса для смешанной реальности](app-patterns-landingpage.md)
Узнайте об основных компонентах для пространственного взаимодействия и пользовательского интерфейса в смешанной реальности.
<br>
