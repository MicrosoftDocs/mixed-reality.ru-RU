...
Для людей новые методы объединяются и расширяют захват и сканирование движения. захват движения является основой для получения детального движения к визуальным эффектам и Цинематик символов, а сканирование имеет опыт для захвата подробного человека. визуальные элементы, такие как лица и руки. Благодаря улучшениям в технологии отрисовки новый метод под названием объемные Video строится на этих приемах, объединяя визуальные и подробные сведения, чтобы создать следующее поколение трехмерных захватов.
...
<td style="border-style: none"><b>Марк Витазко</b><br>@Microsoft конструктора UX</td>
</tr>
</table>
