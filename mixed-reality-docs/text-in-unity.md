...
![, как получить четкий и привлекательный текст](images/hug-text-02-640px.png)<br>
...
![работе со шрифтами в Unity](images/640px-hug-text-03.png)<br>
...
![ная трехмерная сетка Unity с различными размерами шрифта](images/Text_In_Unity_Measurements1.png)<br>
*Масштабирование значений для трехмерного текста Unity и текста пользовательского интерфейса*

<br>

![ная трехмерная сетка Unity с различными размерами шрифта](images/hug-text-05-1000px.png)<br>
...
![текст пользовательского интерфейса Unity с различными динамическими пикселами на значения единиц измерения](images/hug-text-04-1000px.png)<br>
...
![ная трехмерная сетка Unity с различными размерами шрифта](images/Text_In_Unity_Measurements2.png)<br>
*Масштабирование значений для трехмерного текста Unity и текста пользовательского интерфейса*
...
![практический и дальней области взаимодействия](images/typography-distance-1000px.jpg)
...
| Расстояние | Угол просмотра | Высота текста | Font size |
|---------|---------|---------|---------|
...
![угла обзора](images/Text_In_Unity_ViewingAngle.jpg)
*просмотре расстояния, угла и высоты текста*
...
![качество отображения текста с правильным измерением](images/hug-text-06-1000px.png)<br>
