...
# <a name="mr-and-azure-302b-custom-vision"></a>MR и Azure 302B: пользовательские концепции
...
<td> MR и Azure 302B: пользовательские концепции</td><td style="text-align: center;"> ✔️</td><td style="text-align: center;"> ✔️</td>
</tr>
</table>
...
2.  Добавьте **имя** объекта, который вы хотите распознать. Щелкните **сохранить**.
...
10. После завершения сборки вы увидите две кнопки с именем сделать **URL-адрес** **по умолчанию** и прогноз. Щелкните сначала **создать значение по умолчанию** , а затем щелкните **URL-адрес прогноза**.
...
8.  Вернуться в *параметры сборки* *Unity C\# проекты* больше не выделяются. Установите флажок рядом с этим.
...
5.  Выбрав *подключаемый модуль Newtonsoft. JSON* , **Убедитесь, что** **все платформы** не установлены, убедитесь, что **всаплайер** также не **установлен**, а затем нажмите кнопку **Применить**. Это необходимо только для того, чтобы убедиться, что файлы настроены правильно.
...
3.  Щелкните правой кнопкой мыши внутри папки, а затем выберите **Create** > **C\# скрипт**. Назовите сценарий *кустомвисионаналисер*.
...
1.  Щелкните правой кнопкой мыши в папке **Scripts** и выберите **Create** > **C\# Script**. Вызовите скрипт *кустомвисионобжектс*.
...
1.  Щелкните правой кнопкой мыши в папке **Scripts** и выберите **Create** > **C\# Script**. Вызовите скрипт *воицерекогнизер*.
...
1.  Щелкните правой кнопкой мыши в папке **Scripts** и выберите **Create** > **C\# Script**. Вызовите скрипт *кустомвисионтраинер*.
...
1.  Щелкните правой кнопкой мыши в папке **Scripts** и выберите **Create** > **C\# Script**. Назовите сценарий *сценеорганисер*.
...
2.  Щелкните правой кнопкой мыши внутри папки, а затем выберите **Create > C\# скрипт**. Назовите сценарий *имажекаптуре*.
...
2.  **\# проекты Tick Unity C**.

3.  Щелкните **Сборка**. Unity запустит окно **проводника** , в котором необходимо создать, а затем выбрать папку для сборки приложения. Создайте эту папку сейчас и назовите ее **app**Name. Затем в выбранной папке **приложения** щелкните **выбрать папку**.
