...
Ниже приведен краткий обзор того, как организовано данное руководство по проектированию. Разделы для каждой из этих областей содержат ссылки на несколько статей.
* Приступая **[к работе с проектированием](mixed-reality.md)** — Читайте наши обобщенные идеи и изучите принципы, которые мы соблюдаем.
* **[Инстинктуал взаимодействия](interaction-fundamentals.md)** — Узнайте об основах ввода, команд, навигации и других принципах взаимодействия для разработки приложений.
* **[Стиль](typography.md)** . Сделайте приложение удобство с помощью цвета, оформления и движения.
* **[Шаблоны приложений](types-of-mixed-reality-apps.md)** — Узнайте, как приложения могут охватывать сценарии в впечатляющих и реальных средах.
* **[Элементы управления](interactable-object.md)** — используйте элементы управления и шаблоны в качестве стандартных блоков для создания собственного приложения.
* **[Примеры приложений](design.md#sample-apps)** . Создавайте отличные впечатления от примеров, разработанных и созданных нашей группой.
* **[Средства проектирования и ресурсы](design.md#design-tools)** — быстрый запуск проекта с помощью шаблонов и средств разработки.
