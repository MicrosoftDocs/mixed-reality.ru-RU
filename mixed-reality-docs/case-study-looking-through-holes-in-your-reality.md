...
Если вы хотите создать приложение, которое использует эту методику, см. статью [руководстве 101 основы MR](holograms-101.md) в [учебники смешанной реальности](tutorials.md). Глава 7 заканчивается развертывания в вашей floor, отображающую скрытые underworld (как показано на рисунке выше). Кто сказал, что должны были быть нудным руководства?
