...
Указывает, должны ли значения, предоставленные для преобразования влево и вправо, считаться допустимыми и примененными к работающей системе.
...
Поток данных, касающихся контроллеров движения.

**Microsoft. Перцептионсимулатион. Стреамдататипес. глаза**

Поток данных, касающихся глаз имитации человека.

**Microsoft. Перцептионсимулатион. Стреамдататипес. Дисплайконфигуратион**

Поток данных, касающихся конфигурации экрана устройства.
