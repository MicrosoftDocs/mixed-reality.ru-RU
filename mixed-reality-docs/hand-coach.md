...
![пример: ручная](images/HandCoach/MRTK_handCoach.jpg)<br>
*Пример Хандкоач из МРТК*
...
:::row:::
    :::column:::
       ![пример рядом](images/HandCoach/NearSelect.gif) SELECT<br>
       **Пример вблизи Select — показывает, как выбрать кнопки или закрыть взаимодействующие объекты**<br>
    :::column-end:::
    :::column:::
       ![пример](images/HandCoach/AirTap.gif) TAP для Air<br>
    ...
    :::column-end:::
    :::column:::
       ![пример вращения](images/HandCoach/Rotate.gif)<br>
       **Пример поворота — используется для демонстрации поворота голограмм или объектов**<br>
    :::column-end:::
:::row-end:::
...
При анимации рук они должны быть очевидны и шаудн'т вызывать путаницу. Анимация руки — это представление жеста, который вы пытаетесь вызвать пользователю, чтобы понять его назначение. 

Например, если вы хотите, чтобы пользователь нажмет кнопку, будет активирована рука, нажатие кнопки.

![пример: близкое к касанию](images/HandCoach/NearSelect_unity.gif)<br>
...
Мы предоставили Maya-файл с определенной нагрузкой, который можно использовать для приложения, который можно скачать здесь: <a href="files/HandCoach_MRTK.zip">Download HandCoach_MRTK. zip.</a>
...
*   Когда вы довольны анимацией:
    ...
    *  Если имеется несколько анимаций, можно использовать встроенный программа экспорта Maya: https://knowledge.autodesk.com/support/maya/learn-explore/caas/CloudHelp/cloudhelp/2015/ENU/Maya/files/Game-Exporter-htm.html
...
*   Приведя его к Unity, скачайте последнюю версию МРТК здесь: https://github.com/microsoft/MixedRealityToolkit-Unity
    ...
    *   Параметр для каждого проекта
        *   Для сцены задано значение UWP: инструкции см. в [проекте настройки Unity](Configure-Unity-Project.md) для Windows Mixed Reality.
...
* [Настройка проекта Unity](Configure-Unity-Project.md)
* [Обзор разработки в Unity](unity-development-overview.md)
* [МРТК 101](mrtk-101.md)
