...
---
# <a name="add-holographic-remoting"></a>Добавление удаленного взаимодействия holographic
...
Разработчики HoloLens, использующие holographic удаленное взаимодействие, должны обновить свои приложения, чтобы они были совместимы с HoloLens 2.  Для этого потребуется новая версия пакета NuGet для удаленного взаимодействия holographic, которая пока недоступна.  Если приложение, использующее пакет NuGet HoloLens, пытается подключиться к удаленному проигрывателю holographic в HoloLens 2, произойдет сбой подключения.  Просмотрите эту страницу на наличие обновлений после того, как пакет NuGet для HoloLens 2 будет доступен.
