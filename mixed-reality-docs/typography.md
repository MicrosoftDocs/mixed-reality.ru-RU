...
Примеры пандус для типа ![](images/typography-ramp-1000px.jpg)<br>
...
**Более подробные сведения о вычислении размера текста в Unity см. в разделе [текст в Unity](text-in-unity.md) .**
