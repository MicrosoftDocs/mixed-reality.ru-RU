...
Шаг 2. Добавьте источник аудио в лунный модуль. Убедитесь, что в иерархии базовых сцен выбран Лунный модуль, и нажмите кнопку Добавить компонент. Найдите источник аудио и добавьте его в объект. Оставьте поле пустым, пока не забудьте установить флажок "Спатиализе", чтобы включить Пространственный звук. Мы будем использовать его для воспроизведения звука запуска позже.
