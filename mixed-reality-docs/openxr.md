...
По состоянию на июль 2020 среда выполнения Windows Mixed Reality будет поддерживать набор `MSFT` расширений и `EXT` , которые предоставляют полный набор функций HoloLens 2 для опенкср приложений:
...
| Интеграция Direct3D 12 | **Официальное `KHR` расширение в [среде выполнения предварительной версии 2003](openxr-getting-started.md#using-preview-extensions):**<br /><code><a href="https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_KHR_D3D12_enable" target="_blank">XR_KHR_D3D12_enable</a></code><br /><p>**Поддержка в стабильной среде выполнения**: Май 2020 *(запланированная)*</p> |
...
| [Сетка руки артикулатион +](hands-and-tools.md)<p>*Только HoloLens 2*</p> | **`MSFT_preview`расширения в [среде выполнения предварительной версии 2001](openxr-getting-started.md#using-preview-extensions):**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_hand_tracking_preview">XR_MSFT_hand_tracking_preview</a></code><br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_hand_tracking_mesh_preview">XR_MSFT_hand_tracking_mesh_preview</a></code><p>** `MSFT` или `EXT` расширение в среде выполнения предварительной версии**: Май 2020 *(запланированная)*</p> |
| [Отслеживание глаз](eye-tracking.md)<p>*Только HoloLens 2*</p> | ** `EXT` расширение в [среде выполнения предварительной версии 2003](openxr-getting-started.md#using-preview-extensions)**:<br /><code><a href="https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_EXT_eye_gaze_interaction" target="_blank">XR_EXT_eye_gaze_interaction</a></code><p>**Поддержка в стабильной среде выполнения**: Май 2020 *(запланированная)*</p> |
| Взаимодействие с другими пакетами SDK для HoloLens (например, [QR](qr-code-tracking.md))<p>*Только HoloLens 2*</p> | **`MSFT_preview`расширение в [среде выполнения предварительной версии 2001](openxr-getting-started.md#using-preview-extensions):**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_spatial_graph_bridge_preview">XR_MSFT_spatial_graph_bridge_preview</a></code><p>** `MSFT` расширение в среде выполнения предварительной версии**: Май 2020 *(запланированная)*</p> |
| [Запись смешанной реальности <br /> (третья Визуализация с камеры PV)](mixed-reality-capture-for-developers.md#render-from-the-pv-camera-opt-in)<p>*Только HoloLens 2*</p> | **`MSFT_preview`расширения в [среде выполнения предварительной версии 2003](openxr-getting-started.md#using-preview-extensions):**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_secondary_view_configuration_preview">XR_MSFT_secondary_view_configuration_preview</a></code><br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_first_person_observer_preview">XR_MSFT_first_person_observer_preview</a></code><p>** `MSFT` расширение в среде выполнения предварительной версии**: Июнь 2020 *(запланированный)*</p> |
| [Модели отрисовки контроллера движения](motion-controllers.md#rendering-the-motion-controller-model) | **`MSFT_preview`расширение в [среде выполнения предварительной версии 2003](openxr-getting-started.md#using-preview-extensions):**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_controller_model_preview">XR_MSFT_controller_model_preview</a></code><p>** `MSFT` расширение в среде выполнения предварительной версии**: 2020 июля *(запланированная)*</p> |
| [Основные сведения о сцене (плоскости, сетки)](scene-understanding.md)<p>*Только HoloLens 2*</p> | <p>** `MSFT_preview` расширение в среде выполнения предварительной версии**: Июнь 2020 *(запланированный)*</p><p>** `MSFT` расширение в среде выполнения предварительной версии**: 2020 июля *(запланированная)*</p> |
