...
# <a name="mr-and-azure-301-language-translation"></a>MR и Azure 301: языковой перевод
...
<td> MR и Azure 301: языковой перевод</td><td style="text-align: center;"> ✔️</td><td style="text-align: center;"> ✔️</td>
</tr>
</table>
...
6.  Для каждого **текстового объекта**выберите его и используйте приведенные ниже таблицы, чтобы задать параметры на *панели инспектора*.
    ...
    1. Для компонента *преобразования Rect* :
        ...
        | Имя                   | Transform- *позиционирование*             | Ширина      | Равно    |
        |:----------------------:|:----------------------------------:|:----------:|:---------:|
