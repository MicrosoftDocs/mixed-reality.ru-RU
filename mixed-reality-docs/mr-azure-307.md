...
> [!NOTE]
>  Для этого курса **не** потребуется использовать контроллеры движения. Если вам нужна поддержка настройки иммерсивного головного телефона, щелкните [здесь](https://support.microsoft.com/en-au/help/4043101/windows-10-set-up-windows-mixed-reality).
...
3.  Затем перейдите в раздел**параметры сборки** **файлов** > и переключите платформу на **универсальная платформа Windows**, нажав кнопку коммутатора на ***платформе*** .
...
6. На этой панели необходимо проверить несколько параметров:
    ...
    1.  На вкладке **другие параметры** выполните следующие действия.
        ...
        1.  **Создание сценариев** **Версия среды выполнения** должна  быть экспериментальной (эквивалент .NET 4,6)
...
2.  Щелкните правой кнопкой мыши внутри папки и выберите **создать**  >   **C# скрипт**. Вызовите скрипт **продуктпредиктион**.
