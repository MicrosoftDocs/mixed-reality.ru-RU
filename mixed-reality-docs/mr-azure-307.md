...
3.  На панели слева разверните **сохраненные наборы данных* > *Мои наборы данных** и перетащите **ProductsTableCSV** в **Холст эксперимента**.
...
12. Из панели элементов эксперимента в левой части разверните ***машинного обучения* > *Initialize Model* > * классификации *** и перетащите **Мультиклассовой логистической регрессии**  элементов на холст эксперимента.
...
14. В списке элементов эксперимента на панели слева разверните узел **машинного обучения* > * оценка ** и перетащите **Score Model** элементов на холст.

15. Соедините выход, в нижней части **Обучение модели**, на верхний левый вход **оценка модели**.

16. Соедините выход из нижнего правого **разбиение данных**, на верхний правый вход  **Score Model* элемент*.
