...
* В **инспектор** панели под значком Windows Store, выберите черной стрелкой раскрывающегося списка под строкой «Default» и измените значение параметра по умолчанию на **Fastest**.
