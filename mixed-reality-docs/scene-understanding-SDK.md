...
**Примечание.** последний выпуск зависит от предварительной версии пакакжес, и вам потребуется включить пакеты предварительной версии, чтобы увидеть их.
...
Шаги 1-4 сильно зависят от конкретной платформы или реализации, но темы должны быть похожи. Важно отметить, что четыре просто представляют ограниченную двухмерную плоскость, локализованную в пространстве. Если ваш модуль или платформа знает, где четыре – и в корне объекты находятся относительно четырех, то голограммы будут правильно размещены с Репект в реальном мире. Для получения более подробных сведений ознакомьтесь с нашими примерами на четырех, которые демонстрируют конкретные реализации.
