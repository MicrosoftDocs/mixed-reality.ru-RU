...
**Обновитель ввода:** В HoloLens жест выбора — это **касание воздуха**. На впечатляющих гарнитурах мы будем **использовать кнопку на** контроллере Xbox. Дополнительные сведения о входе [начинаются здесь](gestures.md).
