...
> [!NOTE]
> Для этого курса **не** потребуется использовать контроллеры движения. Если вам нужна поддержка настройки иммерсивного головного телефона, [посетите статью Настройка смешанной реальности](https://support.microsoft.com/en-au/help/4043101/windows-10-set-up-windows-mixed-reality).
...
9.  Измените компонент " **Сетка текста** " в соответствии с приведенным ниже:
    ...
    > [!TIP]
    > Выбранный цвет имеет шестнадцатеричный цвет: **000000FF**, хотя вы можете выбрать свой собственный, просто убедитесь, что он доступен для чтения.
...
3.  Щелкните правой кнопкой мыши внутри папки и выберите **создать**  >   **C# скрипт**. Вызовите скрипт *азуресервицес*.
...
2.  Щелкните правой кнопкой мыши внутри папки и выберите **создать**  >   **C# скрипт**. Вызовите скрипт *шапефактори*.
...
2.  Щелкните правой кнопкой мыши на панели проект и выберите **создать**  >   **C# скрипт**. Вызовите скрипт *взгляд*.
