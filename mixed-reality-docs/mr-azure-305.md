...
1.  Добавить **.unitypackage** файла к Unity с помощью **активы** > **Импорт пакета** > **пользовательского пакета**пункт меню.

2.  В **Импорт пакета Unity** поле, отобразятся, вы сможете выбрать все данные **подключаемый модуль** > **хранения**. Снимите флажок, все остальное, так как он не требуется для этого курса.
...
1.  Щелкните правой кнопкой мыши в *активов* папка «проект», **создать** > **папку**. Назовите папку **сценариев**.
