...
|  Имя свойства  |  Введите  |  Значение по умолчанию  |  Описание | 
|----------|----------|----------|----------|
...
|  холограмкомпоситионенаблед  |  Логический  |  TRUE  |  Флаг для включения или отключения голограмм в видеозаписи. | 
|  рекордингиндикаторенаблед  |  Логический  |  TRUE  |  Флаг для включения или отключения индикатора записи на экране во время записи голограммы. | 
|  видеостабилизатионенаблед  |  Логический  |  FALSE  |  Флаг, позволяющий включать или отключать видео стабилизации, включенные в средство регистрации HoloLens. | 
...
|  бланконпротектедконтент  |  Логический  |  FALSE  |  Флаг для включения или отключения возврата пустого кадра, если имеется 2D-приложение UWP, показывающее защищенное содержимое. Если этот флаг имеет значение false, а двухмерная приложение UWP отображает защищенное содержимое, то 2D-приложение UWP будет заменено защищенной текстурой содержимого как на гарнитуре, так и в записи смешанной реальности. |
|  шовхидденмеш  |  Логический  |  FALSE  |  Флаг для включения или отключения отображения скрытой сетки областей и соседнего содержимого камеры Holographic. |
| аутпутсизе | Size (Размер) | 0, 0 | Задайте желаемый размер выходных данных после кадрирования для видео стабилизации. Размер кадрирования по умолчанию выбирается, если задано значение 0 или указан недопустимый размер выходных данных. |
...
<td>
<ul>
<li>0 — только MIC Audio</li>
<li>1: только системные аудио</li>
<li>2: микрофон и звук системы</li>
</ul>
</td>
</tr>
</table>
