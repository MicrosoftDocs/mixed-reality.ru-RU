...
После установки средства можно затем создать holographic проекта DirectX UWP. Чтобы создать новый проект:
...
* [С помощью Visual Studio для развертывания и отладки](using-visual-studio.md)
* [Использование эмулятора HoloLens](using-the-hololens-emulator.md)
* [Использование XAML holographic приложениях DirectX](using-xaml-with-holographic-directx-apps.md)
