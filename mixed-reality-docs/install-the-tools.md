...
| ![Логотип Visual Studio](images/HoloLensIcon.jpg)<br><br><a href="https://go.microsoft.com/fwlink/?linkid=2098508" target="_blank">**Эмулятор HoloLens 2**<br>(ссылка для установки: 10.0.18362.1021)</a><br> <br><a href="https://go.microsoft.com/fwlink/?linkid=2065980" target="_blank">**Эмулятор HoloLens (1-го поколения)**<br>(ссылка для установки: 10.0.17763.253)</a> | Эмулятор позволяет запускать приложения с помощью образа виртуальной машины HoloLens без физического устройства HoloLens.<br> <br> Этот пакет также содержит голографические шаблоны проектов DirectX для Visual Studio. | Дополнительные сведения об использовании эмулятора HoloLens см. в [этой статье](using-the-hololens-emulator.md).<br> <br> Для успешной установки эмулятора **ваша система должна поддерживать Hyper-V**. Подробные сведения см. в разделе о системных требованиях. При желании вы можете установить лишь шаблоны без эмулятора.<br>|
