...
[Глобальные освещенияы в режиме реального времени](https://docs.unity3d.com/Manual/GIIntro.html) в Unity могут предоставлять аустандинг визуальные результаты, но в них включены довольно ресурсоемкие вычисления освещения. Рекомендуется отключить глобальное освещения в режиме реального времени для каждого файла сцены Unity с помощью**параметров освещения** **окна** >  > , > снять флажок **глобальные освещения в реальном времени**. 
