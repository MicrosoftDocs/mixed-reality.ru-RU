...
Оптимальная читаемость текста может уменьшить напряжение глаз и обеспечить удобство работы пользователей, особенно в приложениях или сценариях, требующих от пользователей чтения в виртуальном шлеме. Удобочитаемость текста зависит от ряда факторов, включая различные свойства экрана (например, плотность пикселей, яркость, контрастность), свойства линзы (например, хроматическая аберрация), свойства текста и шрифта (например, специальный характеристики шрифта, такие как толщина, интервал, засечки и пр., цвет шрифта и цвет фона).  

Как правило, рекомендуется тестировать удобочитаемость в каждом приложении отдельно, чтобы сделать размер шрифта максимально удобным для чтения. Ниже мы предлагаем общие рекомендации, которые можно использовать в качестве отправной точки при разработке. Обратите внимание на то, что все размеры шрифтов приводятся в градусах [угла обзора](https://en.wikipedia.org/wiki/Visual_angle), а не в конкретных физических единицах. Это позволяет предоставить рекомендации для любого расстояния в пределах зоны оптимального размещения голограммы, так как учитывается как размер текста, так и расстояние, на котором он отображается от зрителя. 

Более подробные рекомендации представлены на страницах [Оформление текста](typography.md) и [Текст в Unity](text-in-unity.md).

### <a name="guidance-for-holographic-devices"></a>Рекомендации для голографических устройств

На голографических устройствах отображение черного или темного текста на белом или светлом фоне обеспечивает наиболее постоянный коэффициент контрастности, так как фон загораживает помехи из реального мира при отрисовке. При отрисовке белого либо светлого текста на черном или темном фоне через него просвечивает больше элементов реального мира, что может повлиять на удобочитаемость текста. 

#### <a name="hololens-1st-gen"></a>HoloLens (1-го поколения)

Минимальный удобочитаемый размер шрифта (измеряемый от опорной линии до верхнего выносного элемента шрифта) составляет примерно 0,35°, а комфортный размер шрифта — около 0,5° для чтения содержимого, находящегося на расстоянии 2 метров от пользователя. 

#### <a name="hololens-2"></a>HoloLens 2

Минимальный удобочитаемый размер шрифта (измеряемый от опорной линии до верхнего выносного элемента) составляет не менее: 
   - 0,4–0,5° на расстоянии 45 см (расстояние прямого управления); 
   - 0,35–0,4° на расстоянии 2,0 м.
   
Комфортный удобочитаемый размер шрифта (измеряемый от опорной линии до верхнего выносного элемента) составляет не менее: 
   - 0,65–0,8° на расстоянии 45 см (расстояние прямого взаимодействия);
   - 0,6–0,75° на расстоянии 2,0 м.

Обратите внимание на то, что размер шрифта для текста на расстояниях прямого управления должен быть немного больше ввиду описанного выше конфликта между вергенцией и аккомодацией (глаза пользователей аккомодируются на расстоянии в 2 метра на дисплее HoloLens, поэтому содержимое, отображенное, например, в 45 сантиметрах, может казаться более размытым). 

### <a name="guidance-for-immersive-devices"></a>Руководство по иммерсивным устройствам

Как правило, иммерсивное устройство обеспечивает более высокие коэффициенты контрастности ввиду полного загораживания окружающей среды, но может иметь более низкую плотность эффективных пикселей из-за увеличения линз, расположенных перед дисплеями. 

Для иммерсивных виртуальных шлемов Windows Mixed Reality минимальный удобочитаемый вертикальный размер шрифта (измеряемый от опорной линии до верхнего выносного элемента шрифта) составляет примерно 0,7–0,9°, а комфортный вертикальный размер шрифта — около 1,0° для чтения содержимого, находящегося на расстоянии 2 метров от пользователя.
...
![Допустимое поле зрения, определяемое диапазоном отклонения шеи](images/optimal-field-of-view-2.png)<br>
*Допустимое поле зрения, определяемое диапазоном отклонения шеи*
