...
Если используется стандартный шейдер набора средств Mixed Reality, для визуализации глубины прозрачных объектов:
1) Выберите материал транпарент, использующий стандартный шейдер МРТК, и откройте окно редактора инспектора.
2) Установите для **режима рендеринга** значение " **Пользовательский** ", а затем установите **режим** **прозрачность** и установите для параметра **глубина записи глубины** значение **вкл** .
...
|  Включено  |  Настраиваемое  |  Отображение пользовательского экрана-заставки в течение 5 секунд или до загрузки приложения, в зависимости от того, что больше. | 
|  Отключено  |  Нет  |  Показывать прозрачный черный (Nothing) до загрузки приложения. | 
|  Отключено  |  Настраиваемое  |  Отображение пользовательского экрана-заставки в течение 5 секунд или до загрузки приложения, в зависимости от того, что больше. | 
