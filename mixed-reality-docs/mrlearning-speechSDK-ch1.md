...
2. Скачайте [пакет платформы Unity версии 2.1.0](https://github.com/microsoft/MixedRealityToolkit-Unity/releases/download/v2.1.0/Microsoft.MixedReality.Toolkit.Unity.Foundation.2.1.0.unitypackage) для [набора средств для смешанной реальности](https://github.com/microsoft/MixedRealityToolkit-Unity/releases) (Mixed Reality Toolkit) и сохраните его в папке на своем компьютере. Импортируйте пакет в проект Unity. Подробные инструкции по выполнению этой задачи см [. в учебнике Приступая к работе. Инициализация проекта и первого приложения](mrlearning-base-ch1.md).
