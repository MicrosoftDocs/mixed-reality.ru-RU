...
5. После завершения сборки откройте созданную папку, содержащую файлы только что созданного приложения. Дважды щелкните файл решения ". sln", чтобы открыть файл решения в Visual Studio.
